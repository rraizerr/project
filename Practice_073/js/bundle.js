...
function forms(formSelector, modalTimerId) {
    ...
    function bindPostData(form) {
        form.addEventListener("submit", (e) => {
            ...
            (0,_services_services__WEBPACK_IMPORTED_MODULE_1__.postData)("http://localhost:3000/requests", json) // отправляем форму на сервер
            .then(data => {
    ...
    function showThanksModal(message) {
        ...
        (0,_modal__WEBPACK_IMPORTED_MODULE_0__.openModal)(".modal", modalTimerId); // Функция отвечающая за открытие модальных окон
...
window.addEventListener("DOMContentLoaded", () => {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])(".timer", "2022-02-12");
